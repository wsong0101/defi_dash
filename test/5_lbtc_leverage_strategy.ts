...
async function main() {
  ...
  console.log('⚠️  WARNING: This script will calculate required flash loan amount!\n');
  ...
  console.log(`  Initial Equity:     ${formatUnits(initialEquity, decimals)} ${symbol}`);
  ...
  try {
    ...
    const leverageAmount = BigInt(Math.floor(Number(initialEquity) * (multiplier - 1)));
    ...
    console.log(`  Net Worth:          $${netWorthUsd.toFixed(2)} (Collateral - Debt)`);
    console.log(`  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
    console.log(`  Actual Leverage:    ${(totalPositionUsd / netWorthUsd).toFixed(2)}x`);
    ...
    console.log(`  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
    console.log(
      `  Price Drop Buffer:  ${((1 - liquidationPrice / assetPrice) * 100).toFixed(
        1
      )}% before liquidation`
    );
    console.log(`─`.repeat(50));
    ...
    console.log(`  Expected ${symbol}:     ~${expectedOutput.toFixed(8)} ${symbol}`);
